...
#_Bmark_years: beg_bio, end_bio, beg_selex, end_selex, beg_relF, end_relF, beg_recr_dist, end_recr_dist, beg_SRparm, end_SRparm (enter actual year, or values of 0 or -integer to be rel. endyr)
 169 180 169 180 169 180 17 180 17 180 #THIS IS WHAT I have for YFT:168 180 168 180 168 180 140 180 140 180
1 #Bmark_relF_Basis: 1 = use year range; 2 = set relF same as forecast below
#
2 # Forecast: 0=none; 1=F(SPR); 2=F(MSY) 3=F(Btgt); 4=Ave F (uses first-last relF yrs); 5=input annual F scalar
165 # N forecast years
1 # F scalar (only used for Do_Forecast==5)
#_Fcast_years:  beg_selex, end_selex, beg_relF, end_relF, beg_recruits, end_recruits  (enter actual year, or values of 0 or -integer to be rel. endyr)
 0 0 169 180 -999 0 # THIS IS WHAT I HAVE FOR YFT: 168 180 168 180 -999 0
...
500 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 to set to 1999)
